...
public class FileSizeBenchmarks
{
    ...
    {
        var path = Path.Combine(_tempDir, "1m_f32.omx");
    ...
    {
        var path = Path.Combine(_tempDir, "1m_f64.omx");
        using (var writer = OmxFile.CreateWriter(path))
        {
            var group = writer.AddGroup("Data");
    ...
    {
        var path = Path.Combine(_tempDir, "100k_can.omx");
        using (var writer = OmxFile.CreateWriter(path))
        {
    ...
    {
        var path = Path.Combine(_tempDir, "10ch.omx");
        using (var writer = OmxFile.CreateWriter(path))
        {
            var group = writer.AddGroup("Data");
