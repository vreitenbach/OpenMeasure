...
public sealed class BusGroupWriter
{
    ...
    private readonly ChannelWriter<OmxTimestamp> _timestampChannel;
    ...
    {
        _group = group;
        _timestampChannel = group.AddChannel<OmxTimestamp>("Timestamp");
    ...
    public void WriteFrame(OmxTimestamp timestamp, uint frameId, ReadOnlySpan<byte> payload,
    ...
    public void WriteRawFrame(OmxTimestamp timestamp, ReadOnlySpan<byte> rawBytes)
    {
        _timestampChannel.Write(timestamp);
